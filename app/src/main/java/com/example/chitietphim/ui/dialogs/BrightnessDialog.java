package com.example.chitietphim.ui.dialogs;
...
public class BrightnessDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.brighness_dialog, null);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (canWrite) {
                    ...
                    Toast.makeText(context, "Bật cho phép chỉnh độ sáng", Toast.LENGTH_SHORT).show();
