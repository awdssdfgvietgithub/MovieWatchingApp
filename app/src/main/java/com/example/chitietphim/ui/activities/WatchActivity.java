...
import com.example.chitietphim.data.adapter.GridAdapter;
import com.example.chitietphim.data.adapter.IconAdapter;
import com.example.chitietphim.data.model.GridItemModel;
import com.example.chitietphim.data.model.IconModel;
import com.example.chitietphim.data.repo.urls;
import com.example.chitietphim.services.Helper;
import com.example.chitietphim.services.OnSwipeTouchListener;
import com.example.chitietphim.ui.dialogs.BrightnessDialog;
import com.example.chitietphim.ui.dialogs.TrackSelectionDialog;
import com.example.chitietphim.ui.dialogs.VolumeDialog;
...
public class WatchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(WatchActivity.this, ChiTietPhimActivity.class);
    ...
    private void getExtras() {
        ...
        GetDataTheoTheLoai(urls.urlPhimByTheLoai.getStringURL(), maTL);
    }
